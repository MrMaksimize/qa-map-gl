...
class QaMapGlLayer extends QaElementMixin(PolymerElement) {
  static get template() {
    return html`
      <style>
        :host {
  ...
  static get observers() {
    return ["shouldUpdateInstComplex(paint.*, layout.*)"];
  }
...
window.customElements.define('qa-map-gl-layer', QaMapGlLayer);