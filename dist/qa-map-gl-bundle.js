...
"use strict";(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.GeocoderControlImpl={properties:{mglToken:{type:String,value:""}},createInst:function createInst(options){var _keydown=MapboxGeocoder.prototype._onKeyDown;MapboxGeocoder.prototype._onKeyDown=function(e){_keydown.call(this,{target:{value:e.target.value}})};return new MapboxGeocoder({accessToken:this.mglToken})},addInst:function addInst(parent){console.log(parent);console.log(this.elementInst);parent.elementInst.addControl(this.elementInst,this.position);MapboxGeocoder.prototype._onKeyDown=function(e){_keydown.call(this,{target:{value:e.target.value}})}},getInstOptions:function getInstOptions(){return{position:this.position}}};QaMapGlBehavior.GeocoderControl=[QaMapGlBehavior.Control,QaMapGlBehavior.GeocoderControlImpl]})();
