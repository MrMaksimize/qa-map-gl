...
"use strict";(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.DirectionsControlImpl={properties:{mglToken:{type:String,value:""}},createInst:function createInst(options){return new MapboxDirections({accessToken:this.mglToken})},getInstOptions:function getInstOptions(){return{position:this.position}}};QaMapGlBehavior.DirectionsControl=[QaMapGlBehavior.Control,QaMapGlBehavior.DirectionsControlImpl]})();

},{}],96:[function(require,module,exports){
"use strict";(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.GeocoderControlImpl={properties:{mglToken:{type:String,value:""},zoom:{type:Number,value:16},flyTo:{type:Boolean,value:false},placeholder:{type:String,value:"Search"},proximity:{type:Object,value:null},bbox:{type:Array,value:function value(){return null}},types:{type:String,value:null},country:{type:String,value:null},minLength:{type:Number,value:2},limit:{type:Number,value:5},language:{type:String,value:null},lastResults:{type:Object,readOnly:true,notify:true,value:function value(){return null}},selectedResult:{type:Object,readOnly:true,notify:true,value:function value(){return null}}},createInst:function createInst(options){return new MapboxGeocoder({accessToken:this.mglToken,zoom:this.zoom,flyTo:this.flyTo||false,placeholder:this.placeholder,proximity:this.proximity,bbox:this.bbox,types:this.types,country:this.country,minLength:this.minLength,limit:this.limit,language:this.language})},addInst:function addInst(parent){this._retargetKeyDown();parent.elementInst.addControl(this.elementInst,this.position);var onClearFn=this._handleClear.bind(this);var onLoadingFn=this._handleLoading.bind(this);var onResultsFn=this._handleResults.bind(this);var onResultSelectedFn=this._handleResultSelected.bind(this);var onErrorFn=this._handleError.bind(this);this.bindEvents({clear:onClearFn,loading:onLoadingFn,results:onResultsFn,result:onResultSelectedFn,error:onErrorFn})},_handleClear:function _handleClear(e){console.log("clear");console.log(e);this._setLastResults(null);this._setSelectedResult(null)},_handleLoading:function _handleLoading(e){console.log("loading");console.log(e)},_handleResults:function _handleResults(e){console.log("results");console.log(e);this.debounce("set-geocoder-results",function(){this._setLastResults(e)},500)},_handleResultSelected:function _handleResultSelected(e){console.log("resultSet");console.log(e);this._setSelectedResult(e.result)},_handleError:function _handleError(e){console.log("Geocoder Error");console.log(e)},_retargetKeyDown:function _retargetKeyDown(){var _keydown=MapboxGeocoder.prototype._onKeyDown;MapboxGeocoder.prototype._onKeyDown=function(e){_keydown.call(this,{target:{value:e.target.value}})}},getInstOptions:function getInstOptions(){return{position:this.position}}};QaMapGlBehavior.GeocoderControl=[QaMapGlBehavior.Control,QaMapGlBehavior.GeocoderControlImpl]})();

},{}],97:[function(require,module,exports){
"use strict";(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.ControlImpl={properties:{position:{type:String,value:"top-right"}},attached:function attached(){this.notifyInstReady(this.canAddInst());this.listen(this.parentNode,"qa-map-gl-root-load","shouldAddInst")},detached:function detached(){this.shouldRemoveInst()},shouldAddInst:function shouldAddInst(evt){var parent=evt.detail;QaMapGlBehavior.ElementImpl.shouldAddInst.call(this,parent);if(this.elementInst&&parent){this.addInst(parent)}},shouldRemoveInst:function shouldRemoveInst(parent){QaMapGlBehavior.ElementImpl.shouldRemoveInst.call(this,parent);if(this.elementInst){this.removeInst(parent?parent:undefined)}},addInst:function addInst(parent){console.log(parent);console.log(this.elementInst);parent.elementInst.addControl(this.elementInst,this.position)},removeInst:function removeInst(parent){parent.elementInst.removeControl(this.elementInst)},canAddInst:function canAddInst(){return true}};QaMapGlBehavior.Control=[QaMapGlBehavior.Element,QaMapGlBehavior.ControlImpl];QaMapGlBehavior.NavControlImpl={createInst:function createInst(options){return new mapboxgl.NavigationControl},getInstOptions:function getInstOptions(){return{position:this.position}}};QaMapGlBehavior.NavControl=[QaMapGlBehavior.Control,QaMapGlBehavior.NavControlImpl];QaMapGlBehavior.FullScreenControlImpl={createInst:function createInst(options){return new mapboxgl.FullscreenControl},getInstOptions:function getInstOptions(){return{position:this.position}}};QaMapGlBehavior.FullScreenControl=[QaMapGlBehavior.Control,QaMapGlBehavior.FullScreenControlImpl];QaMapGlBehavior.GeolocateControlImpl={properties:{highAccuracy:{type:Boolean,default:false},timeout:{type:Number,default:6000},disableTrackUserLoc:{type:Boolean,default:false},disableShowUserLoc:{type:Boolean,default:false}},createInst:function createInst(options){return new mapboxgl.GeolocateControl(options)},getInstOptions:function getInstOptions(){return{position:this.position,positionOptions:{enableHighAccuracy:this.enableHighAccuracy,timeout:this.timeout},trackUserLocation:!this.disableTrackUserLoc,showUserLocation:!this.disableShowUserLoc}}};QaMapGlBehavior.GeolocateControl=[QaMapGlBehavior.Control,QaMapGlBehavior.GeolocateControlImpl];QaMapGlBehavior.ScaleControlImpl={properties:{maxWidth:{type:String,default:"150"},unit:{type:String,default:"metric"}},createInst:function createInst(options){return new mapboxgl.ScaleControl(options)},getInstOptions:function getInstOptions(){return{position:this.position,maxWidth:this.maxWidth,unit:this.unit}}};QaMapGlBehavior.ScaleControl=[QaMapGlBehavior.Control,QaMapGlBehavior.ScaleControlImpl];QaMapGlBehavior.AttributionControlImpl={properties:{compact:{type:Boolean}},createInst:function createInst(options){return new mapboxgl.AttributionControl(options)},getInstOptions:function getInstOptions(){return{position:this.position,compact:this.compact}}};QaMapGlBehavior.AttributionControl=[QaMapGlBehavior.Control,QaMapGlBehavior.AttributionControlImpl]})();

},{}],98:[function(require,module,exports){
"use strict";var _getIterator2=require("babel-runtime/core-js/get-iterator");var _getIterator3=_interopRequireDefault(_getIterator2);var _keys=require("babel-runtime/core-js/object/keys");var _keys2=_interopRequireDefault(_keys);var _typeof2=require("babel-runtime/helpers/typeof");var _typeof3=_interopRequireDefault(_typeof2);var _assign=require("babel-runtime/core-js/object/assign");var _assign2=_interopRequireDefault(_assign);var _weakMap=require("babel-runtime/core-js/weak-map");var _weakMap2=_interopRequireDefault(_weakMap);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.ElementImpl={properties:{debug:{type:Boolean,value:false}},beforeRegister:function beforeRegister(){this.elementInst=null},attached:function attached(){this.__elAttached=true},detached:function detached(){this.__elAttached=false},notifyInstReady:function notifyInstReady(){var isReady=arguments.length>0&&arguments[0]!==undefined?arguments[0]:true;if(!isReady)return false;this.fire("qa-map-gl-element-ready-to-add");return true},shouldAddInst:function shouldAddInst(){if(!this.elementInst){var options=this.__initialOptions=this.getInstOptions();this.elementInst=this.createInst(options);this.fire("qa-map-gl-element-instance-created")}this.__instEvents=this.__instEvents||[];this.__instEventsElementsMap=this.__instEventsElementsMap||new _weakMap2.default},shouldRemoveInst:function shouldRemoveInst(){this.unbindAllEvents(this.__instEvents,this.__instEventsElementsMap);this.__instEvents=null;this.__instEventsElementsMap=null},shouldUpdateInst:function shouldUpdateInst(){if(!this.elementInst&&this.__elAttached&&this.canAddInst()){this.notifyInstReady(this.canAddInst())}if(!this.elementInst)return;var lastOptions=this.__lastOptions||this.__initialOptions;var nextOptions=this.getInstOptions();if(this.is!=="qa-map-gl"){this.updateInst(lastOptions,nextOptions,this.parentNode)}else{this.updateInst(lastOptions,nextOptions)}this.__lastOptions=nextOptions},createInst:function createInst(){throw new Error("The `createInst` method must be implemented.")},updateInst:function updateInst(){throw new Error("The `updateInst` method must be implemented.")},getInstOptions:function getInstOptions(){throw new Error("The `getInstOptions` method must be implemented.")},addInst:function addInst(){throw new Error("The `bindInst` method must be implemented.")},removeInst:function removeInst(){throw new Error("The `unbindInst` method must be implemented.")},extendObj:function extendObj(obj){if(!obj||!(obj instanceof Object))throw new Error("The first parameter of `extendObj` must be an object to be mutated.");for(var _len=arguments.length,properties=Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){properties[_key-1]=arguments[_key]}if(properties.length){_assign2.default.apply(Object,[obj].concat(properties))}return obj},addProperties:function addProperties(){this.properties=this.properties||{};for(var _len2=arguments.length,properties=Array(_len2),_key2=0;_key2<_len2;_key2++){properties[_key2]=arguments[_key2]}if(properties.length){this.extend.apply(this,[this.properties].concat(properties))}return this.properties},bindEvents:function bindEvents(evts,target){if((typeof evts==="undefined"?"undefined":(0,_typeof3.default)(evts))!=="object"||!(0,_keys2.default)(evts).length)return;var el=target||this.elementInst;if(!el||!el.on)return;var boundEvts=this.__instEvents;var boundEvtEls=this.__instEventsElementsMap;for(var evtName in evts){var evtReference={name:evtName,fn:evts[evtName]};el.on(evtReference.name,evtReference.fn);boundEvts.push(evtReference);boundEvtEls.set(evtReference,el)}},unbindAllEvents:function unbindAllEvents(boundEvts,boundEvtEls){if(!boundEvts||!boundEvts.length||!boundEvtEls)return;var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=(0,_getIterator3.default)(boundEvts),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var evt=_step.value;var el=boundEvtEls.get(evt);if(!el||!el.off)continue;var name=evt.name,fn=evt.fn;el.off(name,fn);boundEvtEls.delete(evt)}}catch(err){_didIteratorError=true;_iteratorError=err}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return()}}finally{if(_didIteratorError){throw _iteratorError}}}},debugLog:function debugLog(message){if(this.debug===true)console.log(message)},isShadyScoped:function isShadyScoped(){console.log(Polymer.settings);return!Polymer.Settings.useNativeShadow},getShadyScope:function getShadyScope(){return"style-scope qa-map-gl"}};QaMapGlBehavior.Element=[QaMapGlBehavior.ElementImpl]})();
...
"use strict";var _keys=require("babel-runtime/core-js/object/keys");var _keys2=_interopRequireDefault(_keys);var _typeof2=require("babel-runtime/helpers/typeof");var _typeof3=_interopRequireDefault(_typeof2);var _getIterator2=require("babel-runtime/core-js/get-iterator");var _getIterator3=_interopRequireDefault(_getIterator2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.LayerImpl={properties:{id:{type:String},layerType:{type:String},source:{type:String},sourceLayer:{type:String,observer:"shouldUpdateInst"},visibility:{type:String,value:"visible",observer:"shouldUpdateInst"},layout:{type:Object,value:function value(){return{}}},paint:{type:Object,value:function value(){return{}}},minZoomVisible:{type:Number,value:0,observer:"shouldUpdateInst"},maxZoomVisible:{type:Number,value:22,observer:"shouldUpdateInst"},filter:{type:Array,observer:"shouldUpdateInst"},events:{type:String,observer:"shouldUpdateInst"},beforeLayer:{type:String}},observers:["shouldUpdateInstComplex(paint.*, layout.*)"],attached:function attached(){this.notifyInstReady(this.canAddInst());this.listen(this.parentNode,"qa-map-gl-root-load","shouldAddInst");this.listen(this.parentNode,"qa-map-gl-root-styledata","shouldAddInst")},detached:function detached(){this.shouldRemoveInst()},shouldUpdateInstComplex:function shouldUpdateInstComplex(paint,layout){this.debounce("shouldUpdateInstDebounce",function(){QaMapGlBehavior.ElementImpl.shouldUpdateInst.call(this,parent)},250)},shouldAddInst:function shouldAddInst(evt){var parent=evt.detail;QaMapGlBehavior.ElementImpl.shouldAddInst.call(this,parent);if(this.elementInst&&parent&&parent.elementInst.getLayer(this.id)==undefined){this.addInst(parent)}},shouldRemoveInst:function shouldRemoveInst(parent){QaMapGlBehavior.ElementImpl.shouldRemoveInst.call(this,parent);if(this.elementInst){this.removeInst(parent?parent:undefined)}},createInst:function createInst(options){var layerInst=options;return layerInst},addInst:function addInst(parent){var beforeLayer=this.beforeLayer||undefined;if(beforeLayer!==undefined&&(beforeLayer==="fill"||beforeLayer==="symbol"||beforeLayer==="circle"||beforeLayer==="heatmap"||beforeLayer==="background"||beforeLayer==="raster"||beforeLayer==="fill-extrusion"||beforeLayer==="line")){var layers=parent.elementInst.getStyle().layers;var labelLayerIdx=layers.findIndex(function(layer){return layer.type===beforeLayer});beforeLayer=labelLayerIdx!==-1?layers[labelLayerIdx].id:undefined}parent.elementInst.addLayer(this.elementInst,beforeLayer);var eventBindings={};if(this.events&&this.events!==""){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=(0,_getIterator3.default)(this.events.split(",")),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var evt=_step.value;eventBindings[evt]=this._broadcastEvent.bind(this)}}catch(err){_didIteratorError=true;_iteratorError=err}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return()}}finally{if(_didIteratorError){throw _iteratorError}}}this.bindEvents(eventBindings,parent)}},removeInst:function removeInst(parent){parent.removeLayer(this.id);this.elementInst.remove()},updateInst:function updateInst(lastOptions,nextOptions,parent){for(var lpKey in nextOptions.layout){parent.elementInst.setLayoutProperty(this.id,lpKey,nextOptions.layout[lpKey])}for(var pKey in nextOptions.paint){parent.elementInst.setPaintProperty(this.id,pKey,nextOptions.paint[pKey])}parent.elementInst.setLayerZoomRange(this.id,nextOptions.minzoom,nextOptions.maxzoom);parent.elementInst.setFilter(this.id,nextOptions.filter)},bindEvents:function bindEvents(evts,parent){if((typeof evts==="undefined"?"undefined":(0,_typeof3.default)(evts))!=="object"||!(0,_keys2.default)(evts).length)return;var mapRoot=parent.elementInst;var layerId=this.id;var boundEvts=this.__instEvents;var boundEvtEls=this.__instEventsElementsMap;for(var evtName in evts){var evtReference={name:evtName,fn:evts[evtName]};mapRoot.on(evtReference.name,layerId,evtReference.fn);boundEvts.push(evtReference);boundEvtEls.set(evtReference,mapRoot)}},unbindAllEvents:function unbindAllEvents(boundEvts,boundEvtEls){if(!boundEvts||!boundEvts.length||!boundEvtEls)return;var _iteratorNormalCompletion2=true;var _didIteratorError2=false;var _iteratorError2=undefined;try{for(var _iterator2=(0,_getIterator3.default)(boundEvts),_step2;!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){var evt=_step2.value;var el=boundEvtEls.get(evt);var name=evt.name,fn=evt.fn;el.off(name,this.id,fn);boundEvtEls.delete(evt)}}catch(err){_didIteratorError2=true;_iteratorError2=err}finally{try{if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return()}}finally{if(_didIteratorError2){throw _iteratorError2}}}},_broadcastEvent:function _broadcastEvent(e){console.log("broadcasting event "+e.type+" from layer "+this.id);console.log(e);this.fire(e.type,{"features":e.features,"lngLat":e.lngLat,"point":e.point})},_switchPointer:function _switchPointer(e){if(e.type==="mouseenter"){e.target.getCanvas().style.cursor="pointer"}else{e.target.getCanvas().style.cursor=""}},canAddInst:function canAddInst(){return true},getInstOptions:function getInstOptions(){var options={id:this.id,type:this.layerType,source:this.source,minzoom:this.minZoomVisible,maxzoom:this.maxZoomVisible,layout:this.layout,paint:this.paint};options.layout.visibility=this.visibility;if(this.sourceLayer)options["source-layer"]=this.sourceLayer;if(this.filter&&Array.isArray(this.filter))options["filter"]=this.filter;return options}};QaMapGlBehavior.Layer=[QaMapGlBehavior.Element,QaMapGlBehavior.LayerImpl]})();
