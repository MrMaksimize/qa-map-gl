...
"use strict";(function(){"use strict";window.QaMapGlBehavior=window.QaMapGlBehavior||{};QaMapGlBehavior.GeocoderControlImpl={properties:{mglToken:{type:String,value:""}},createInst:function createInst(options){return new MapboxGeocoder({accessToken:this.mglToken})},getInstOptions:function getInstOptions(){return{position:this.position}}};QaMapGlBehavior.GeocoderControl=[QaMapGlBehavior.Control,QaMapGlBehavior.GeocoderControlImpl]})();
